...
plt.xticks([0.0, 0.1, 0.2, 0.3, v_mpp, 0.5, 0.536, 0.6],["0.0", "0.1", "0.2", "0.3", "v_mpp", "0.5", "v_0c", "0.6"])
...
otro_y.set_ylabel("P [mW/cm^2]")
otro_y.set_xlim(0, 0.6)
otro_y.set_ylim(0, 17.5)
otro_y.set_yticks([0, 2.5, 5.0, 7.5, 10.0, 12.5, 15, maxima_p, 17.5], ["0", "2.5", "5", "7.5", "10", "12.5", "15", "P_max", "17.5"])
...
plt.savefig("INFORMES\INFORME2\Simulacion _Celda/Grafica.png")
plt.show()
