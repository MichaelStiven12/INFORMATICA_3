...
#Recorrer la secuencia de numeros (1, 3, 5, ..., 2001) y luego contar cuantas veces numero es multiplo de 11 y 5 a la vez
...
secuencia2 = range(2, 600)
cont1 = 0
while cont1 < len(secuencia2):
    print(secuencia2[cont1], end = "-")
    cont1 += 2
    print(secuencia2[cont1], end = "-")
    cont1 += 1
    print(secuencia2[cont1], end = "-")
...
secuencia3 = range(1, 100)
cont2 = 1
while cont2 < len(secuencia3):
    print(2**cont2, end = "-")
    cont2 += 1
